...
import illustrationFeatures from "../imgs/illustration-features-tab-1.png";
import illustrationFeatures2 from "../imgs/illustration-features-tab-2.png";
import illustrationFeatures3 from "../imgs/illustration-features-tab-3.png";
      ...
      <section className="bg-bookmark-white py-20 mt-20 lg:mt-60">
        ...
        <div className="relative mt-20 lg:mt-52">
          <div className="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24">
            <div className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
              <img className="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full" src={illustrationFeatures2} alt="" />
            </div>
            <div className="flex flex-1 flex-col items-center lg:items-start">
